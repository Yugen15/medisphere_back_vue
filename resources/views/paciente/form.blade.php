<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="dui" class="form-control @error('dui') is-invalid @enderror" value="{{ old('dui', $paciente?->dui) }}" id="dui" placeholder="Dui">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_nacimiento" class="form-control @error('fecha_nacimiento') is-invalid @enderror" value="{{ old('fecha_nacimiento', $paciente?->fecha_nacimiento) }}" id="fecha_nacimiento" placeholder="Fecha Nacimiento">
