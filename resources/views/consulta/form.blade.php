<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha" class="form-control @error('fecha') is-invalid @enderror" value="{{ old('fecha', $consulta?->fecha) }}" id="fecha" placeholder="Fecha">
            {!! $errors->first('fecha', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="estado" class="form-label">{{ __('Estado') }}</label>
            <input type="text" name="estado" class="form-control @error('estado') is-invalid @enderror" value="{{ old('estado', $consulta?->estado) }}" id="estado" placeholder="Estado">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_cita" class="form-control @error('id_cita') is-invalid @enderror" value="{{ old('id_cita', $consulta?->id_cita) }}" id="id_cita" placeholder="Id Cita">
